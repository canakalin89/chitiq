...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  const navItems: { view: ViewState; icon: React.ReactNode; label: string }[] = [
    ...
    {
      view: 'history',
      label: t('nav.history') || (language.startsWith('tr') ? 'Geçmiş' : 'History'),
      icon: (
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.8}>
    ...
    {
      view: 'exam-setup',
      label: t('nav.examMode') || (language.startsWith('tr') ? 'Sınav Modu' : 'Exam Mode'),
      icon: (
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.8}>
    ...
    {
      view: 'class-manager',
      label: t('nav.classManager') || (language.startsWith('tr') ? 'Sınıf Yönetimi' : 'Classes'),
      icon: (
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.8}>
    ...
    {
      view: 'analytics',
      label: t('nav.analytics') || (language.startsWith('tr') ? 'Analitik' : 'Analytics'),
      icon: (
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.8}>
